...
const uint16_t FONT_CLOCK_DATA_1[CLOCK_FONT_HEIGHT]     = {0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000};
...
const uint16_t FONT_CLOCK_DATA_M[CLOCK_FONT_HEIGHT]     = {0x8800,0xD800,0xA800,0x8800,0x8800,0x8800,0x8800};

const Character FONT_CLOCK_SPACE{FONT_CLOCK_DATA_SPACE, 1};
const Character FONT_CLOCK_0{FONT_CLOCK_DATA_0, 4};
const Character FONT_CLOCK_1{FONT_CLOCK_DATA_1, 4};
...
const Character FONT_CLOCK_M{FONT_CLOCK_DATA_M, 5};

const Character char_list[] = {
		FONT_CLOCK_0,
		FONT_CLOCK_1,
		FONT_CLOCK_2,
		FONT_CLOCK_3,
