...
static const uint16_t FONT_CLOCK_DATA_1[CLOCK_FONT_HEIGHT]     = {0x8000,0x8000,0x8000,0x8000,0x8000,0x8000,0x8000};
...
static const uint16_t FONT_CLOCK_DATA_A[CLOCK_FONT_HEIGHT]     = {0xE000,0xA000,0xE000,0xA000,0xA000,0x0000,0x0000};
static const uint16_t FONT_CLOCK_DATA_P[CLOCK_FONT_HEIGHT]     = {0xE000,0xA000,0xE000,0x8000,0x8000,0x0000,0x0000};
static const uint16_t FONT_CLOCK_DATA_M[CLOCK_FONT_HEIGHT]     = {0x8800,0xD800,0xA800,0x8800,0x8800,0x0000,0x0000};

static const Character FONT_CLOCK_SPACE{FONT_CLOCK_DATA_SPACE, 0};
static const Character FONT_CLOCK_0{FONT_CLOCK_DATA_0, 4};
static const Character FONT_CLOCK_1{FONT_CLOCK_DATA_1, 1};
